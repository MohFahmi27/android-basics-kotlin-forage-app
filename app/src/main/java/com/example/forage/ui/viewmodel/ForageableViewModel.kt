...
class ForageableViewModel(
    ...
    val allForageable: LiveData<List<Forageable>> = forageableDao.getForgeables().asLiveData()

    // TODO : create method that takes id: Long as a parameter and retrieve a Forageable from the
    //  database by id via the DAO.
    fun getForeable(id: Long) = forageableDao.getForageable(id).asLiveData()
    ...
    // TODO: launch a coroutine and call the DAO method to add a Forageable to the database within
